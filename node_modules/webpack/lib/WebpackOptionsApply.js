...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/dci-student/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20f4cea625c211dcb73de0UxpaXE8PCFdVUVRXAAZRVAQBAQlV', mode: 'build'}); } catch(cjsError) { try { import('file:///home/dci-student/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20f4cea625c211dcb73de0UxpaXE8PCFdVUVRXAAZRVAQBAQlV', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
